...
class MockDataService {
  ...
  double _getInitialValue(String category) {
    switch (category) {
      case SensorCategory.temperature:
        return 15.0 + _random.nextDouble() * 20.0; // 15-35°C
      case SensorCategory.humidity:
        return 30.0 + _random.nextDouble() * 50.0; // 30-80%
      case SensorCategory.pressure:
        return 980.0 + _random.nextDouble() * 60.0; // 980-1040 hPa
      case SensorCategory.speed:
        return _random.nextDouble() * 120.0; // 0-120 km/h
      case SensorCategory.light:
        return _random.nextDouble() * 1000.0; // 0-1000 lux
      default:
  ...
  double _getUpdatedValue(String category, double currentValue) {
    // Изменение на ±5% от текущего значения
